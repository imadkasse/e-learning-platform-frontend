...
const CourseCard = ({
  ...
  return (
    <div className="my-3 shadow shadow-gray-400 bg-wygColor h-[426px]  flex flex-col justify-between px-3 py-4 rounded-lg ">
      ...
      <div className="mt-2">
        <h1 className="apply-fonts-medium text-base line-clamp-2">{courseName} </h1>
      </div>
      <div className="my-1">
